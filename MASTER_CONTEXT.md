...
│   │
│   ├── [E3] Định chế nhận tiền gửi (NHTM cốt lõi) ── [TRỤC ĐÀO SÂU CH02a & CH03]
...
│   │   └── 3.7 Khung Phân tích Toàn diện CAMEL(S) (6 Khía cạnh sức khỏe ngân hàng)
│   │       ├── Chữ C (Capital Adequacy - An toàn vốn): Vốn tự có (Tier 1 vs Tier 2), RWA nội/ngoại bảng, Ví dụ "Ly nước mía", Ẩn dụ "Ăn kem - Chạy bộ", Chuẩn CAR Basel & VN (≥ 8%), Proxy Indicator (Vốn CSH / Tổng tài sản)
│   │       ├── Chữ A (Asset Quality - Chất lượng tài sản): Bất đối xứng thông tin, Tập trung ngành/địa bàn, Tỷ lệ nợ xấu NPL, Trích lập dự phòng RRTD & Tỷ lệ bao phủ nợ xấu (LLR)
│   │       ├── Chữ M (Management Soundness - Lành mạnh quản trị): Tiếp cận định tính & Định lượng, Tỷ lệ chi phí (CIR), Thu nhập trên nhân viên, Tốc độ mở rộng mạng lưới
│   │       ├── Chữ E (Earnings & Profitability - Hiệu quả thu nhập & Lợi nhuận): Cơ cấu thu nhập Lãi NII vs Phi lãi, 5 chỉ số ROA, ROE, NIM, NIIR, Earning Spread, DuPont
│   │       ├── Chữ L (Liquidity Indicators - Khả năng thanh khoản): Dòng tiền Inflows/Outflows, Tài sản thanh khoản, LDR truyền thống (loại trừ liên ngân hàng, Big 4 vs Tư nhân), LDR mở rộng, Xung đột An toàn xã hội vs Tối ưu cổ đông
│   │       └── Chữ S (Sensitivity to Market Risk - Độ nhạy rủi ro thị trường): Rủi ro thị trường (Giá, Tỷ giá NOP, Lãi suất IRRBB), Khe hở lãi suất GAP = RSA - RSL, Bài toán thực nghiệm 2 trường hợp, Asymmetric Adjustment (Huy động tăng nhanh hơn cho vay), Tình huống chiến lược Ngân hàng A vs B
│   │
...
### Bảng Diễn giải Quan hệ Chi tiết (Bao gồm các liên kết mở rộng từ CH03)
...
| **CH04** | **Chiến lược kinh doanh ngân hàng & Chuyển đổi số** | `[E3]`, `[E8]`, `[E7]` | **Chiến lược Cạnh tranh, Tăng trưởng & Ngân hàng số:** Chiến lược Đại dương xanh, Ngân hàng bán lẻ vs Bán buôn, Tích hợp Fintech/Platform, Ngân hàng Mở (Open Banking), Quản trị trải nghiệm khách hàng đa kênh (Omnichannel) và xây dựng hệ sinh thái tài chính số. | **DỰ KIẾN KẾ TIẾP** |

---
*Ghi chú duy trì tính liên tục (Continuity Note):* File này là bộ nhớ dùng chung xuyên suốt toàn bộ học phần. Khi thực hiện các chương kế tiếp (`CH04`...), tuyệt đối không thay đổi mã số của các Entity đã được định danh (`E1` đến `E8`). Các chương sau chỉ bổ sung kiến thức chuyên sâu vào Entity tương ứng và cập nhật bảng Chapter Coverage.
